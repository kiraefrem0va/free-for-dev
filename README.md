...
Developers and Open Source authors now have EXTREMELY MANY services offering free tiers, but finding them all takes time to make informed decisions.

This is a big tiny box of software (SaaS, PaaS, IaaS, etc.) and other offerings with free developer tiers.
